...
public:
    ...
    void Update(const Point_t& pt, const CRegion& region, bool dataCorrect, size_t max_trace_length, cv::Mat prevFrame, cv::Mat currFrame, int64 currTime, int frameInd);
